...
## Project Structure
    ...
    ├── shahr_figma_login_d_24226  # Django project configurations
...
1. Clone this repo and `cd shahr_figma_login_d_24226`
...
2. Clone this repo and `cd shahr_figma_login_d_24226`
